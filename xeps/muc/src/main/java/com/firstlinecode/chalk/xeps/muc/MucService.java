...
import com.firstlinecode.chalk.xeps.muc.events.ChangeNick;
...
import com.firstlinecode.chalk.xeps.muc.events.Kick;
import com.firstlinecode.chalk.xeps.muc.events.KickEvent;
import com.firstlinecode.chalk.xeps.muc.events.Kicked;
...
import com.firstlinecode.chalk.xeps.muc.events.RoomMessage;
...
public class MucService implements IMucService, IMessageListener, IPresenceListener {
	...
	public void received(Presence presence) {
		if (presence.getObject() instanceof MucUser) {
			...
			RoomEvent<?> event;
			com.firstlinecode.basalt.xeps.muc.user.Item item = mucUser.getItems().get(0);
